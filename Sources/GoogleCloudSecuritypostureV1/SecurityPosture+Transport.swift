...
extension Clients {
  class SecurityPostureTransport: SecurityPostureStub {
    let inner: GoogleCloudGax.HTTPClient

    public init(_ options: GoogleCloudGax.ClientOptions = .init()) throws {
      self.inner = try GoogleCloudGax.HTTPClient(
        from: options, withDefaultEndpoint: "https://securityposture.googleapis.com")
    }
    ...
    public func listPostures(
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudSecuritypostureV1.ListPosturesResponse.self, from: data)
    }
    ...
    public func listPostureRevisions(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudSecuritypostureV1.ListPostureRevisionsResponse.self, from: data)
    }
    ...
    public func getPosture(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudSecuritypostureV1.Posture.self, from: data)
    }
    ...
    public func listPostureDeployments(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudSecuritypostureV1.ListPostureDeploymentsResponse.self, from: data)
    }
    ...
    public func getPostureDeployment(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudSecuritypostureV1.PostureDeployment.self, from: data)
    }
    ...
    public func listPostureTemplates(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudSecuritypostureV1.ListPostureTemplatesResponse.self, from: data)
    }
    ...
    public func getPostureTemplate(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudSecuritypostureV1.PostureTemplate.self, from: data)
    }
